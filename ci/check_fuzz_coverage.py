...
KERNELS = {
    ...
    "sse41": ["hex_encode_sse41", "encode_sse41_16", "hex_check_sse_with_case",
              "hex_decode_sse41_checked", "hex_decode_short_sse41", "hex_decode_sse41", "decode_sse41_block",
              "decode_sse41_nibbles", "pack_sse41"],
    "avx2": ["hex_encode_avx2", "encode_avx2_32", "hex_check_avx2_with_case",
             "hex_decode_avx2_checked", "hex_decode_avx2", "hex_decode_avx2_owned", "decode_avx2_block",
             "decode_avx2_nibbles", "pack_avx2"],
    "avx512": ["hex_check_avx512_with_case", "valid_avx512",
               "hex_decode_avx512_checked", "hex_decode_avx512", "hex_decode_avx512_owned",
    ...
    "neon": ["hex_encode_neon", "encode_neon_8", "encode_neon_16",
             ...
             "hex_decode_short_neon", "hex_decode_bounded_neon", "hex_decode_neon", "hex_decode_neon_owned",
